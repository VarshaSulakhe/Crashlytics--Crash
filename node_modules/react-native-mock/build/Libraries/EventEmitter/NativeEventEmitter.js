...
_this._nativeModule=nativeModule;return _this;}_createClass(NativeEventEmitter,[{key:'addListener',value:function(){function addListener(


eventType,listener,context){
return _get(Object.getPrototypeOf(NativeEventEmitter.prototype),'addListener',this).call(this,eventType,listener,context);}return addListener;}()},{key:'removeAllListeners',value:function(){function removeAllListeners(


eventType){
invariant(eventType,'eventType argument is required.');
_get(Object.getPrototypeOf(NativeEventEmitter.prototype),'removeAllListeners',this).call(this,eventType);}return removeAllListeners;}()},{key:'removeSubscription',value:function(){function removeSubscription(


subscription){
_get(Object.getPrototypeOf(NativeEventEmitter.prototype),'removeSubscription',this).call(this,subscription);}return removeSubscription;}()}]);return NativeEventEmitter;}(EventEmitter);
